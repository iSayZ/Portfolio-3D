...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  return (
    <Card className="overflow-hidden group relative cursor-pointer hover:bg-muted transition" onClick={() => window.open(project.link, '_blank')}>
      {project.isActive && (
        <Badge 
          variant="default" 
      ...
      {project.logo ? (
   <div className="flex items-center justify-center h-full" style={{ backgroundColor: project.bgColor }}>
     <Image
       src={project.logo}
       alt={project.title}
       width={300}
