        ...
        <div className="space-y-12 px-6">
            ...
            <div className="flex flex-wrap justify-center gap-3">
                {softSkills.map((skill: Skill) => (
                    <div key={skill.name} className="h-min w-min py-2 px-4 flex items-center gap-2 border border-muted rounded-md cursor-pointer"             style={{
                        backgroundColor: hoveredSkill === skill.name ? `${skill.color}50` : `${skill.color}20`,
                        color: skill.color,
