...
const About = () => {
  ...
  return (
    <section id="about" className="min-h-screen w-full py-12 flex flex-col items-center justify-center gap-16 bg-background">
